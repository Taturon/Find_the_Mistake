...
<span>難易度</span><br>
<label>
<input type="radio" name="difficulty" value="易しい（絵文字）"
<?php if (empty($difficulty) || isset($difficulty) && $difficulty === '易しい（絵文字）') echo 'checked';?>
>易しい（絵文字）
</label>
<label>
<input type="radio" name="difficulty" value="難しい（漢字）"
<?php if (isset($difficulty) && $difficulty === '難しい（漢字）') echo 'checked';?>
>難しい（漢字）
</label>
</p>
